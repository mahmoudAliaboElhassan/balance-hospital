...
export const shiftHoursTypeSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getShiftHoursTypesForRoster.pending, (state) => {
        state.loadingGetShiftHoursTypes = true
        state.error = null
      })
      .addCase(getShiftHoursTypesForRoster.fulfilled, (state, action) => {
        state.loadingGetShiftHoursTypes = false
        state.error = null
      ...
      .addCase(getShiftHoursTypesForRoster.rejected, (state, action) => {
        state.loadingGetShiftHoursTypes = false
        state.error = {
          message: i18next.t("shiftHoursTypes.fetchError"),
          errors: action.payload?.errors || [],
