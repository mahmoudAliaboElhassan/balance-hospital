                          ...
                          <div className="relative" ref={dropdownRef}>
                            <div className="relative">
                              <input
                                ...
                                placeholder={
                                  t(
                                    "departmentForm.placeholders.searchUsers"
                                  ) ||
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            >
                              ...
                              >
                                {t(
                                  "departmentForm.fields.canManageSchedules"
                      ...
                      <div className="space-y-6">
                        ...
                        >
                          <div className="flex flex-col items-center space-y-3">
                            ...
                            >
                              {t("departmentForm.noUsersMessage") ||
                                "There are no users available to assign as department manager. Please create users first before creating departments."}
                            </p>
                          </div>
                        </div>
                      </div>
